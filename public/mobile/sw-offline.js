...
const CACHE_NAME = 'solucnet-tecnicos-v1.74.2-NAP-OFFLINE-PERMISOS';
...
self.addEventListener('install', (event) => {
    console.log('[SW] 🔄 Instalando Service Worker v1.74.2 - NAP PERMISOS OFFLINE...');
    event.waitUntil(
        caches.keys().then((cacheNames) => {
            ...
            console.log('[SW] ✅ Service Worker v1.74.2 instalado correctamente');
...
// Mensaje de log
console.log('[SW] ✅ Service Worker SolucNet Técnicos v1.74.2 CARGADO - NAP Offline + Permisos Sincronizados');
