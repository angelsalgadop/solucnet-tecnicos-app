...
const CACHE_NAME = 'solucnet-tecnicos-v1.72.0-FIX-FILTRADO-VISITAS';
...
self.addEventListener('install', (event) => {
    console.log('[SW] 🔄 Instalando Service Worker v1.72 - FIX FILTRADO VISITAS...');
    event.waitUntil(
        caches.keys().then((cacheNames) => {
            ...
            console.log('[SW] ✅ Service Worker v1.72 instalado correctamente');
...
// Mensaje de log
console.log('[SW] ✅ Service Worker SolucNet Técnicos v1.72 CARGADO - Fix Filtrado de Visitas Completadas');
